...
<body>
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Design List</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active">Design List</li>
            </ol>
            ...
            <a href="<?= site_url('adddesign'); ?>" class="btn btn-primary">Add Design</a></h4>
            <div class="card-body">
                <table id="datatablesSimple">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $row['price'] ?></td>
                            <td>
                                <img src="<?= "designs/".$row['image']; ?>" height="100px" width="100px" alt="image">
                            </td>
                            <td>
                                <a href="<?= site_url('design_list/edit/'.$row['id']) ?>">
                                <i class="btn btn-info fa fa-eye" aria-hidden="true"></i></a>
                                
                                <a href="<?= site_url('design_list/delete/'.$row['id']) ?>" 
